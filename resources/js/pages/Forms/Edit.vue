...
import { type EditForm, type BreadcrumbItem } from '@/types';
...
const submit = () => {
    form.transform((data) => ({
        ...data,
        _method: 'patch',
    })).post(`/forms/${props.form.id}`);
};

</script>

<template>
    <Head title="Editar Candidatura" />

    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
            <div class="mx-auto w-full max-w-2xl">
                <div class="mb-6">
                    <h1 class="text-2xl font-semibold text-foreground">Editar Candidatura</h1>
                    <p class="mt-2 text-sm text-muted-foreground">
                        Atualize as informações da sua candidatura abaixo.
                    </p>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="rounded-xl border border-sidebar-border/70 bg-background p-6 dark:border-sidebar-border">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="mb-2 text-sm text-muted-foreground">
                                <span v-if="props.form.cv_path" class="text-green-600 dark:text-green-400">
                                    CV atual: Arquivo anexado
                                </span>
                                <span v-else class="text-red-600 dark:text-red-400">
                                    Nenhum CV anexado atualmente
                                </span>
                            </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Atualizando...' : 'Atualizar Candidatura' }}
                        </button>
                        <a
